...
const { buildParamsForPlatform, buildSecondData, relayerFeeAddress, royaltyFeeAddress} = require('./test-utils')
...
contract('WyvernExchange', (accounts) => {
    ...
    const erc721_for_platform_token_test = async (options) => {
        ...
        let paramsOne = buildParamsForPlatform(addressesOne, tokenIdAndAmountOne, relayerFee, royaltyFee, hasFee, hasRoyaltyFee, false)
        ...
        let paramsTwo = buildParamsForPlatform(addressesTwo, tokenIdAndAmountTwo, relayerFee, royaltyFee, hasFee, hasRoyaltyFee, false)
