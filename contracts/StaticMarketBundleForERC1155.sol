...
contract StaticMarketBundleForERC1155 is StaticMarketBase {
        ...
        bytes memory data, bytes memory counterdata) public pure returns (uint)
    {
        ...
        // TODO: addresses[2] is the atomicizer address, how to check it?
        // require(addresses[2] == tokenGive[0], "ERC1155BundleForERC20: call target must equal address of token to give");
        ...
        bytes memory data, bytes memory counterdata) public pure returns (uint)
    {
        ...
        // TODO: addresses[2] is the atomicizer address, how to check it?
        // require(addresses[5] == tokenGet[0], "ERC20ForERC1155Bundle: call target must equal address of token to give");
        ...
        bytes memory data, bytes memory counterdata) public pure returns (uint)
    {
        ...
        // TODO: addresses[2] and addresses are the atomicizer address, how to check it?
        // require(addresses[2] == tokenGive[0], "ERC1155BundleForERC20WithOneFee: call target must equal address of token to give");
        // require(addresses[5] == tokenGiveGetAndFeeRecipient[1], "ERC1155BundleForERC20WithOneFee: countercall target must equal address of token to get");
        ...
        bytes memory data, bytes memory counterdata) public pure returns (uint)
    {
        ...
        // TODO: addresses[2] and addresses[5] are the atomicizer address, how to check it?
        // require(addresses[5] == tokenGiveGetAndFeeRecipient[1], "ERC20ForERC1155BundleWithOneFee: call target must equal address of token to give");
        // require(addresses[2] == tokenGiveGetAndFeeRecipient[0], "ERC20ForERC1155BundleWithOneFee: call target must equal address of token to give");
        ...
        bytes memory data, bytes memory counterdata) public pure returns (uint)
    {
        ...
        // TODO: addresses[2] and addresses are the atomicizer address, how to check it?
        // require(addresses[2] == tokenGive[0], "ERC1155BundleForERC20WithTwoFees: call target must equal address of token to give");
        // require(addresses[5] == tokenGiveGetAndFeeRecipient[1], "ERC1155BundleForERC20WithTwoFees: countercall target must equal address of token to get");
        ...
        bytes memory data, bytes memory counterdata) public pure returns (uint)
    {
        ...
        // TODO: addresses[2] and addresses[5] are the atomicizer address, how to check it?
        // require(addresses[5] == tokenGiveGetAndFeeRecipient[1], "ERC20ForERC1155BundleWithTwoFees: call target must equal address of token to give");
        // require(addresses[2] == tokenGiveGetAndFeeRecipient[0], "ERC20ForERC1155BundleWithTwoFees: call target must equal address of token to give");
