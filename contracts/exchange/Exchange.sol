...
contract Exchange is ExchangeCore {
    ...
    /*
    * uints[16]: order's relayer fee recipient
    * uints[17]: order's royalty fee recipient
    * uints[18]: counterorder's relayer fee recipient
    * uints[19]: counterorder's royalty fee recipient
    *
    * uints[20]: order's relayer fee
    * uints[21]: order's royalty fee
